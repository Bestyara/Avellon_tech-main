...
from PySide6.QtWidgets import QApplication, QMainWindow, QFileDialog, QCheckBox, QWidget, \
...
from ui.graphs import XYDataFrame, OscilloscopeGraphWidget, AmplitudeTimeGraphWidget, \
    FrequencyResponseGraphWidget, WindRoseGraphWidget, DepthResponseGraphWidget
from ui.common import AbstractFunctor, HelpInfoDialog, SimpleItemListWidget, \
...
from ui.common import loading
from domain import Borehole, DataFile, Section, Step
import config as cf
...
class BoreholeMenuWindowWidget(QWidget):
    ...
    def __init__(self, project_id_: str, main_window_: MainWindow):
        ...
        from ui.dialogs import ConverterDialog
